...
export default function About({}: Props) {
  return (
      <motion.div
          ...
          <h3 className='absolute md:top-24 top-20 sm:top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>à propos</h3>
          ...
          <motion.img
              ...
              className='my-20 mx-20 mt-80 sm:mt-40 -mb-5 md:mb-0 flex-shrink-0 w-56 h-56 sm:w-[300px] sm:h-[300px]
